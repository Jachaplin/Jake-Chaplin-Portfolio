              ...
              <div className="card card-testimonial">
                ...
                <div className="card-body">
                  <p className="card-description" style={{textAlign: 'left'}}>
                    Super stoked about my new website <a target='_blank' href="https://www.tavius.org">www.tavius.org!</a> I have had this website over a decade and it has never been so clean and beautiful. I was able to integrate my social media posts to automatically update my website blog when I wanted. Social media integration with a professional website is so much better! I also was able to integrate my different vendors for my eCommerce business into my website. This makes selling easier.
